...
export function storageFor(name) {
  // line below creates an empty object with no prototype
  // common pattern for when we want an object as a dictionary
  // with no inherited properties from Object.prototype
  let storage = Object.create(null)

  // Initialize common propeties with hardcoded data
  ...
  // Conditional data based on names
  ...
  // Generate data based on characters in name string
  // Calculate a hash and generate a series of values
  // Seems to simulate dynamic data
  let hash = 0
  ...
  // stringify all properties: function converts properties to JSON strings
